%% Build a function of applying five format filters to synthesize sound
function source_signal = FiveFormatFilters_synthesis(midi_freqs, format_bandwidths_hz)
